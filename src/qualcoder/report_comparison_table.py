...
class DialogReportComparisonTable(QtWidgets.QDialog):
    ...
    def __init__(self, app, parent_text_edit):
        ...
        self.ui.pushButton_select_cases.setIcon(qta.icon('mdi6.button-cursor', options=[{'scale_factor': 1.4}]))
        self.ui.pushButton_select_cases.pressed.connect(self.select_cases)
        self.ui.pushButton_select_attributes.setIcon(qta.icon('mdi6.cursor-default', options=[{'scale_factor': 1.4}]))
