...
class DialogReportCodeFrequencies(QtWidgets.QDialog):
    ...
    def __init__(self, app, parent_textedit):
        ...
        self.ui.pushButton_export_excel.setIcon(qta.icon('mdi6.microsoft-excel', options=[{'scale_factor': 1.3}]))
...
class DialogReportCoderComparisons(QtWidgets.QDialog):
    ...
    def __init__(self, app, parent_textedit):
        ...
        self.ui.pushButton_clear.setIcon(qta.icon('mdi6.broom', options=[{'scale_factor': 1.4}]))
