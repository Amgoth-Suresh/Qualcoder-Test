...
class DialogSelectAttributeParameters(QtWidgets.QDialog):
    ...
    def __init__(self, app, limiter="all", parent=None):
        ...
        self.ui.pushButton_save_filter.setIcon(qta.icon('mdi6.filter-plus', options=[{'scale_factor': 1.2}]))
        self.ui.pushButton_save_filter.clicked.connect(self.filter_settings_save)
        self.ui.pushButton_load_filter.setIcon(qta.icon('mdi6.download-outline', options=[{'scale_factor': 1.2}]))
        self.ui.pushButton_load_filter.clicked.connect(self.filter_settings_load)
        self.ui.pushButton_delete_filter.setIcon(qta.icon('mdi6.filter-remove', options=[{'scale_factor': 1.2}]))
