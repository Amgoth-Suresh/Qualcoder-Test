...
class ViewGraph(QDialog):
    ...
    def __init__(self, app):
        ...
        self.ui.pushButton_export.setIcon(qta.icon('mdi6.image-move', options=[{'scale_factor': 1.5}]))
        ...
        self.ui.pushButton_reveal.setIcon(qta.icon('mdi6.eye', options=[{'scale_factor': 1.5}]))
        self.ui.pushButton_reveal.pressed.connect(self.reveal_hidden_items)
        self.ui.pushButton_clear.setIcon(qta.icon('mdi6.broom', options=[{'scale_factor': 1.5}]))
        self.ui.pushButton_clear.pressed.connect(self.clear_items)
        self.ui.pushButton_selectbranch.setIcon(qta.icon('mdi6.file-tree', options=[{'scale_factor': 1.5}]))
        self.ui.pushButton_selectbranch.pressed.connect(self.select_tree_branch)
        self.ui.pushButton_freetextitem.setIcon(qta.icon('mdi6.text-box-edit-outline', options=[{'scale_factor': 1.5}]))
        self.ui.pushButton_freetextitem.pressed.connect(self.add_text_item_to_graph)
        self.ui.pushButton_addfile.setIcon(qta.icon('mdi6.file-plus', options=[{'scale_factor': 1.5}]))
        self.ui.pushButton_addfile.pressed.connect(self.add_files_to_graph)
        self.ui.pushButton_addcase.setIcon(qta.icon('mdi6.tab-plus', options=[{'scale_factor': 1.5}]))
        self.ui.pushButton_addcase.pressed.connect(self.add_cases_to_graph)
        self.ui.pushButton_addline.setIcon(qta.icon('mdi6.vector-line', options=[{'scale_factor': 1.5}]))
        self.ui.pushButton_addline.pressed.connect(self.add_lines_to_graph)
        self.ui.pushButton_loadgraph.setIcon(qta.icon('mdi6.download-outline', options=[{'scale_factor': 1.5}]))
        ...
        self.ui.pushButton_savegraph.setIcon(qta.icon('mdi6.file-document-refresh', options=[{'scale_factor': 1.5}]))
        self.ui.pushButton_savegraph.pressed.connect(self.save_graph)
        self.ui.pushButton_deletegraph.setIcon(qta.icon('mdi6.delete', options=[{'scale_factor': 1.5}]))
        self.ui.pushButton_deletegraph.pressed.connect(self.delete_saved_graph)
        self.ui.pushButton_codes_of_text.setIcon(qta.icon('mdi6.text', options=[{'scale_factor': 1.5}]))
        ...
        self.ui.pushButton_codes_of_images.setIcon(qta.icon('mdi6.image-album', options=[{'scale_factor': 1.5}]))
        ...
        self.ui.pushButton_codes_of_av.setIcon(qta.icon('mdi6.monitor-eye', options=[{'scale_factor': 1.5}]))
        self.ui.pushButton_codes_of_av.pressed.connect(self.add_codes_of_av_files)
        self.ui.pushButton_memos_of_file.setIcon(qta.icon('mdi6.text-long', options=[{'scale_factor': 1.5}]))
