...
class Ui_DialogCharts(object):
    def setupUi(self, DialogCharts):
        ...
        self.line.setGeometry(QtCore.QRect(340, 50, 20, 565))
        self.line.setFrameShape(QtWidgets.QFrame.Shape.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line.setObjectName("line")
        self.label_chart_attributes = QtWidgets.QLabel(parent=DialogCharts)
        self.label_chart_attributes.setGeometry(QtCore.QRect(10, 435, 261, 22))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.radioButton_default = QtWidgets.QRadioButton(parent=self.groupBox_palette)
        self.radioButton_default.setGeometry(QtCore.QRect(5, 9, 90, 22))
        self.radioButton_default.setChecked(True)
        self.radioButton_default.setObjectName("radioButton_default")
        

        self.radioButton_color_blind = QtWidgets.QRadioButton(parent=self.groupBox_palette)
        self.radioButton_color_blind.setGeometry(QtCore.QRect(100, 9, 110, 22))
        self.radioButton_color_blind.setObjectName("radioButton_color_blind")

        self.radioButton_corporate = QtWidgets.QRadioButton(parent=self.groupBox_palette)
        self.radioButton_corporate.setGeometry(QtCore.QRect(220, 9, 120, 22))
        self.radioButton_corporate.setObjectName("radioButton_corporate")
        ...
        self.label_chart_options_2.setGeometry(QtCore.QRect(10, 255, 321, 22))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.line_4.setGeometry(QtCore.QRect(10, 245, 331, 16))
        self.line_4.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_4.setObjectName("line_4")
        self.comboBox_heatmap = QtWidgets.QComboBox(parent=DialogCharts)
        self.comboBox_heatmap.setGeometry(QtCore.QRect(10, 390, 321, 25))
        ...
        self.comboBox_wordcloud_background.setGeometry(QtCore.QRect(380, 400, 321, 22))
        ...
        self.comboBox_wordcloud_foreground.setGeometry(QtCore.QRect(380, 450, 321, 22))
        ...
        self.pushButton_wordcloud.setGeometry(QtCore.QRect(580, 540, 50, 50))
        ...
        self.lineEdit_count_limiter.setGeometry(QtCore.QRect(260, 350, 71, 22))
        ...
        DialogCharts.setTabOrder(self.comboBox_bar_charts, self.comboBox_heatmap)
...
"Codings from the entire text file are used for the calculations."))
        ...
        self.radioButton_default.setText(_translate('DialogCharts','Default'))
        self.radioButton_corporate.setText(_translate('DialogCharts','Corporate'))
        self.radioButton_color_blind.setText(_translate('DialogCharts','Color Blind'))
        ...
        self.label_chart_options_2.setText(_translate("DialogCharts", "<b>Matrix View</b>"))
        # Create description label with manual geometry (just below Matrix View title)
        self.label_matrix_description = QtWidgets.QLabel(DialogCharts)
        self.label_matrix_description.setObjectName("label_matrix_description")
        self.label_matrix_description.setWordWrap(True)
        self.label_matrix_description.setStyleSheet("color: gray; font-size: 10pt;")
        self.label_matrix_description.setText(_translate(
            "DialogCharts",
            "Displays a matrix-style comparison of files/cases vs. codes."
            "Use the Upper Count Limiter to set a maximum value so extreme counts don't distort the colors."
        ))
        # Title for Background comboBox
        self.label_wordcloud_background_title = QtWidgets.QLabel(parent=DialogCharts)
        self.label_wordcloud_background_title.setText(_translate("DialogCharts", "Background"))
        self.label_wordcloud_background_title.setObjectName("label_wordcloud_background_title")
        self.label_wordcloud_background_title.setGeometry(QtCore.QRect(380, 370, 321, 25))  # Adjust position as necessary

        # Title for Foreground comboBox
        self.label_wordcloud_foreground_title = QtWidgets.QLabel(parent=DialogCharts)
        self.label_wordcloud_foreground_title.setText(_translate("DialogCharts", "Foreground"))
        self.label_wordcloud_foreground_title.setObjectName("label_wordcloud_foreground_title")
        self.label_wordcloud_foreground_title.setGeometry(QtCore.QRect(380, 420, 321, 25))  # Adjust position as necessary

        self.label_matrix_description.setGeometry(QtCore.QRect(10, 280, 321, 49))
