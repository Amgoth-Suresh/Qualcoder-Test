# Form implementation generated from reading ui file 'c:\Users\kai\Documents\Programmierung\2023QualCoder\src\GUI_UIs\ui_dialog_settings.ui'
#
...
class Ui_Dialog_settings(object):
    def setupUi(self, Dialog_settings):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -237, 795, 841))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.comboBox_ai_profile = QtWidgets.QComboBox(parent=self.widget_ai_provider)
        self.comboBox_ai_profile.setEditable(False)
        self.comboBox_ai_profile.setInsertPolicy(QtWidgets.QComboBox.InsertPolicy.NoInsert)
        self.comboBox_ai_profile.setObjectName("comboBox_ai_profile")
        self.gridLayout_6.addWidget(self.comboBox_ai_profile, 0, 1, 1, 1)
        ...
        self.pushButton_ai_profile_edit = QtWidgets.QPushButton(parent=self.widget_ai_provider)
        self.pushButton_ai_profile_edit.setObjectName("pushButton_ai_profile_edit")
        self.gridLayout_6.addWidget(self.pushButton_ai_profile_edit, 0, 2, 1, 1)
...
""))
        ...
        self.pushButton_ai_profile_edit.setText(_translate("Dialog_settings", "Edit Name"))
