...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # Reason: Disabled creation of AI Chat tab in the layout.
        ...
        self.actionAI_Setup_wizard.setMenuRole(QtGui.QAction.MenuRole.NoRole)
        ...
        self.actionAI_Configuration = QtGui.QAction(parent=MainWindow)
        self.actionAI_Configuration.setMenuRole(QtGui.QAction.MenuRole.NoRole)
        self.actionAI_Configuration.setObjectName("actionAI_Configuration")
        ...
        self.menuReports.addAction(self.actionCode_co_occurrence)
        ...
        self.menuAI.addAction(self.actionAI_Configuration)
        ...
        # AI_CHAT_DISABLED (Aug 2025)
        # Reason: Disabled AI Chat menu action.
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_coding.setText(_translate("MainWindow", "Select an option in the Labeling menu. "))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_coding), _translate("MainWindow", "Labeling"))
        ...
        # AI_CHAT_DISABLED (Aug 2025)
        # Reason: Disabled AI Chat tab label.
        ...
        self.menuCoding.setTitle(_translate("MainWindow", "Labeling"))
        ...
        self.actionCodes.setText(_translate("MainWindow", "Label text"))
        ...
        self.actionCoding_summary.setText(_translate("MainWindow", "Labeling summary"))
        ...
        self.actionCoding_comparison.setText(_translate("MainWindow", "Comparing Coders"))
        ...
        self.actionCode_image.setText(_translate("MainWindow", "Label image"))
        self.actionCode_frequencies.setText(_translate("MainWindow", "Label frequencies"))
        self.actionCoding_Matrix.setText(_translate("MainWindow", "Coding Matrix"))
        self.actionCode_audio_video.setText(_translate("MainWindow", "Label audio/video"))
        ...
        self.actionCode_relations.setText(_translate("MainWindow", "Label relations"))
        ...
        self.actionCode_summary.setText(_translate("MainWindow", "Label summary"))
        self.actionCoding_comparison_by_file.setText(_translate("MainWindow", "Comparing Labels by file"))
        self.actionCode_by_case.setText(_translate("MainWindow", "Label by case"))
        ...
        self.actionCode_pdf.setText(_translate("MainWindow", "Label pdf"))
        self.actionCode_text_exact_matches.setText(_translate("MainWindow", "Label text exact matches"))
        ...
        self.actionAI_Configuration.setText(_translate("MainWindow", "Settings"))
        self.actionAI_Configuration.setToolTip(_translate("MainWindow", "AI related Settings"))
        self.actionAI_Prompts.setText(_translate("MainWindow", "Prompt library"))
        self.actionCode_organiser.setText(_translate("MainWindow", "Label organiser"))
        self.actionText_segments_by_codes.setText(_translate("MainWindow", "Labels by text segments"))
        self.actionAI_assisted_coding.setText(_translate("MainWindow", "AI assisted coding"))
        self.actionCode_co_occurrence.setText(_translate("MainWindow", "Label co-occurrence"))
        self.actionCode_comparison_table.setText(_translate("MainWindow", "Label counts by file/case"))
