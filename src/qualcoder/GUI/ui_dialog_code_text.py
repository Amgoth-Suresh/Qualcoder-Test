...
class Ui_Dialog_code_text(object):
    ...
    def retranslateUi(self, Dialog_code_text):
        ...
        self.pushButton_auto_code.setToolTip(_translate("Dialog_code_text", "<html><head/><body><p>Auto code with exact text.</p><p>Right click for options: all, first, last.</p></body></html>"))
