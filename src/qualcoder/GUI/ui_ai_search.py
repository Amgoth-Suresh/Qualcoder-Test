...
class Ui_Dialog_AiSearch(object):
    ...
    def retranslateUi(self, Dialog_AiSearch):
        ...
        self.label_5.setText(_translate("Dialog_AiSearch", "Analytic Prompt:"))
        self.pushButton_change_prompt.setToolTip(_translate("Dialog_AiSearch", "Edit prompt or create your own (advanced option)"))
        self.pushButton_change_prompt.setText(_translate("Dialog_AiSearch", " Edit "))
