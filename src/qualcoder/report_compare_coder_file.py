...
class DialogCompareCoderByFile(QtWidgets.QDialog):
    ...
    def __init__(self, app, parent_text_edit):
        ...
        self.ui.pushButton_clear.setIcon(qta.icon('mdi6.broom', options=[{'scale_factor': 1.3}]))
        self.ui.pushButton_export_odt.setIcon(qta.icon('mdi6.receipt-text-send-outline', options=[{'scale_factor': 1.3}]))
